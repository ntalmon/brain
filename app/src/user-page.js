...
import fetchAPI, { formatURL } from "./utils";
      ...
      return (
        <ul>
          <li>
            ...
            <br />
            Translation: (
            {[pose.translation.x, pose.translation.y, pose.translation.z].join(
              ", "
            )}
            )
            <br />
...
function Post(props) {
  ...
  let date = new Date(parseInt(props.datetime));
  return (
    <div>
    ...
    <div className="usersPage">
      <div className="profile">
        ...
        <div>
          ...
          <span className="userDetail">Birthday: {user.birthday}</span>
